class NewComicSource extends ComicSource {  // 首行必须为class...
    ...
    // 更新链接
    url = "https://github.com/lingxidev/venconfigs/blob/main/mhtmh.js"
    ...
    account = {
        ...
        login: async (account, pwd) => {
            let res = await Network.post("https://www.mhtmh.org/api/user/userarr/login", {
        ...
        registerWebsite: "https://www.mhtmh.org/user/register/"
    }
    parseComic(element) {
    ...
    explore = [
        {
            ...
            */
            load: async () => {
                let url = "https://mhtmh.org/cate/hotblooded/"
                ...
                // let res = await Network.get("https://www.mhtmh.org/", {
                //     "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.6 Mobile/15E148 Safari/604.1"
                // })
                // if (res.status !== 200) {
                //     throw "Invalid status code: " + res.status
    ...
    categoryComics = {
        load: async (category, param, options, page) => {
            ...
            let url = "https://www.mhtmh.org/cate/xuanhuan"
            let res = await Network.get(url, {
                "Referer": "https://mhtmh.org/cate/",
                "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.6 Mobile/15E148 Safari/604.1"
            })
    ...
    search = {
          load: async (keyword, options, page) => {
            let res = await Network.get(`https://www.mhtmh.org/api/search?keyword=${encodeURIComponent(keyword)}&type=mh&page=1&pageSize=3`, {
                "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.6 Mobile/15E148 Safari/604.1"
            })
            if (res.status !== 200) {
                throw "Invalid status code: " + res.status
    ...
    favorites = {
        ...
        addOrDelFavorite: async (comicId, folderId, isAdding) => {
            ...
            if (isAdding) {
                ...
                let res = await Network.post("https://www.mhtmh.org/api/user/bookcase/add", {
                ...
                let res = await Network.post("https://www.mhtmh.org/api/user/bookcase/del", {
                    "Content-Type": "application/x-www-form-urlencoded",
                    "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.6 Mobile/15E148 Safari/604.1"
                }, `articleid=${id}`)
                if (res.status !== 200) {
        ...
        loadComics: async (page, folder) => {
            let res = await Network.post("https://www.mhtmh.org/api/user/bookcase/ajax", {
                "Content-Type": "application/x-www-form-urlencoded",
                "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.6 Mobile/15E148 Safari/604.1"
            }, `page=${page}`)
            if (res.status !== 200) {
            ...
            let comics = json["data"].map(e => {
                return {
                    ...
                    subTitle: e["author"],
                    cover: e["cover"],
                    id: "https://www.mhtmh.org" + e["info_url"]
                }
            })
    ...
    comic = {
        ...
        loadInfo: async (id) => {
            ...
            let res = await Network.get(`https://www.mhtmh.org${id}`, {
                    "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.6 Mobile/15E148 Safari/604.1"
                })
            if (res.status !== 200) {
                throw "Invalid status code: " + res.status
            ...
            let infoRes = await Network.get(`https://www.mhtmh.org/api${id}`, {
                    "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.6 Mobile/15E148 Safari/604.1"
                })
        ...
        loadEp: async (comicId, epId) => {
            ...
            let res = await Network.get(
                `https://www.mhtmh.org/api/comic/image/${id}?page=1&page_size=${picCount}&image_source=${imageSource}`,
                {
                    "Referer": `https://www.mhtmh.org/comic/${comicId}/${ep}`,
                    "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.6 Mobile/15E148 Safari/604.1"
                }
            )
            if (res.status !== 200) {
        ...
        matchBriefIdRegex: "https://www.mhtmh.org/(\\d+)/"
    }
    settings = { 
        search_api: {
            title: "搜索方式",
